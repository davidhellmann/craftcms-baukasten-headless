...
export type NewsDetailPageQuery = {
  __typename?: "Query";
  entry?:
    | {
        __typename?: "errorPages_error_Entry";
...
} as unknown as DocumentNode<GetAllEntriesQuery, GetAllEntriesQueryVariables>;
...
export const NewsDetailPageDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "NewsDetailPage" },
      variableDefinitions: [
        {
          kind: "VariableDefinition",
            ...
            arguments: [
              {
                kind: "Argument",
                name: { kind: "Name", value: "section" },
                value: { kind: "StringValue", value: "news", block: false },
              },
              {
                kind: "Argument",
...
} as unknown as DocumentNode<NewsDetailPageQuery, NewsDetailPageQueryVariables>;
