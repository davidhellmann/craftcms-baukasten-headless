import { capitalizeFirstLetter as uCFL } from '@utils/capitalizeFirstLetter';
...
interface ISetSectionAndEntryType {
  handle: string;
  type: string;
}

export const setSectionAndEntryType = (params: ISetSectionAndEntryType) => {
